                ...
                <form name="cartForm" method="post" action="${path}/do/?action=order-books">
                    <table class="table table-bordered">
                        ...
                        <tr>
                            ...
                            <th scope="col" style="width: 5%"><fmt:message key="cart.price.field"/></th>
                            <th scope="col" style="width: 5%"><fmt:message key="cart.quantity.field"/></th>
                            <th style="width: 2%"></th>
                        </tr>
                        </thead>
                        <tbody>
                        <c:forEach var="cart" items="${cart}" varStatus="i">
                            <tr>
                                ...
                                <td><a href="${path}/do/?action=delete-book-from-cart&book=${cart.key.id}">x</a></td>
                            </tr>
                        </c:forEach>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-outline-primary" type="submit" name="order"
                                        onclick="return onOrder();"><fmt:message key="cart.button.message"/>
                                </button>
                            </td>
                        </tr>
                        </tbody>
...
<script language="Javascript">
    function onOrder() {
        ...
        document.cartForm.submit();             // Submit the page
        return true;
    }
